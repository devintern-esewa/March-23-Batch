...
public class ProductServiceImplTest {
    ...
    public void getAllProductsThenReturnProducts() {
        ...
        assertEquals(productList.get(0).getProductId(), productServiceImpl.getAllProducts().get(0).getProductId());
    }
    ...
    public void getProductWhenIdIsValidThenReturnProduct() {
        ...
        assertEquals(p2.getProductId(), productServiceImpl.getProduct(5).getProductId());
    ...
    public void addProductWhenAllDataIsValidThenReturnProduct() {
        ...
        assertEquals(productDto.getProductId(), productServiceImpl.addProduct(productDto).getProductId());
    }
    ...
    public void addProductWhenDataProvidedIsInvalidThenReturnException() {
        ProductDto productDto = new ProductDto(-2, "Laptop", -8000.0, "Electronics", "Best");
